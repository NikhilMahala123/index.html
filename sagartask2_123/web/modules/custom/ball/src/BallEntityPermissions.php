...
use Drupal\ball\Entity\BallEntityType;


/**
 * Provides dynamic permissions for Ball entity of different types.
 *
 * @ingroup ball
 *
 */
class BallEntityPermissions{
   ...
   *
   * @return array
   *   The BallEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (BallEntityType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\ball\Entity\BallEntityType $type
   *   The BallEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(BallEntityType $type) {
    $type_id = $type->id();
